...
<head>
    ...
    <title>Wasla - Create Project</title>
    <meta name="description" content="Create a new project on Wasla.">
                    ...
                    <div class="settings-card">
                        ...
                        <div class="settings-form">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" id="project-name" placeholder="e.g. Insomnia Gaming Festival 2026">
                            </div>
                            <div class="form-row">
                                <div class="form-group"><label class="form-label">Event Date *</label><input type="date" class="form-input" id="project-date"></div>
                                <div class="form-group"><label class="form-label">End Date</label><input type="date" class="form-input" id="project-end-date"></div>
                            </div>
                            <div class="form-row">
                                <div class="form-group"><label class="form-label">Location *</label><input type="text" class="form-input" id="project-location" placeholder="e.g. The Ritz-Carlton, Riyadh"></div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-input form-textarea" id="project-desc" placeholder="Describe your project..." rows="4"></textarea>
                            </div>
                            <div class="form-group">
                ...
                <div class="step-panel" id="step-3">
                    <div class="settings-card">
                        ...
                        <div class="form-actions">
                            ...
                            <button class="btn-save btn-submit" onclick="submitProject()"><i class="fas fa-check"></i> Create Project</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function submitProject(){
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Show a friendly pending message
