            ...
            <div class="settings-page">
                ...
                <div class="settings-panel" id="panel-appearance">
                    ...
                    <div class="settings-card">
                        ...
                        <div class="form-group"><select class="form-input" id="settings-language"><option value="en">English</option><option value="ar">العربية (Arabic)</option><option value="fr">Français (French)</option></select></div>
                    </div>
                </div>
            </div>
        </main>
